# Generated by Django 2.2.6 on 2019-12-09 19:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('N', 'Not Hired'), ('H', 'Hired')], default='N', max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avg_rating', models.FloatField(default=0)),
                ('num_ratings', models.IntegerField(default=0)),
                ('cook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='database.Cook')),
            ],
        ),
        migrations.CreateModel(
            name='Manager',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('food', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.Food')),
